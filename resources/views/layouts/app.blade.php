...
<body>
    <header class="w-full">
        <nav class="w-full bg-purple-600 p-1 text-white flex justify-center">
    ...
    @yield('content')
    <footer class="mt-12">
        <div class="max-w-full bg-purple-600 p-4"></div>
        <div class="max-w-full text-center bg-gray-700 text-white p-4">
            <div class="text-lg font-bold">@MyLaravelBlog By <a class="hover:underline" href="https://cosasdedevs.com/" target="_blank">Sofía Sanmartín</a></div>
        </div>
    </footer>
</body>
</html>
